...
export declare type TldrawSession =
  | ArrowSession
  | BrushSession
  | DrawSession
  | HandleSession
...
export declare type SessionArgsOfType<K extends SessionType> = ExceptFirst<
  ConstructorParameters<SessionOfType<K>>
>;
export declare const sessions: {
  [K in SessionType]: SessionsMap[K];
};
export declare const getSession: <K extends SessionType>(
  type: K
) => SessionOfType<K>;
