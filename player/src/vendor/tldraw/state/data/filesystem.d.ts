...
export declare function saveFileHandle(
  fileHandle: FileSystemFileHandle | null
): Promise<void>;
export declare function saveToFileSystem(
  document: TDDocument,
  fileHandle: FileSystemFileHandle | null,
  name?: string
...
export declare function openAssetsFromFileSystem(): Promise<
  import("browser-fs-access").FileWithHandle[]
>;
export declare function fileToBase64(
  file: Blob
): Promise<string | ArrayBuffer | null>;
export declare function fileToText(
  file: Blob
): Promise<string | ArrayBuffer | null>;
