...
export declare class TLDR {
  ...
  static mutateShapes<T extends TDShape>(
    ...
    pageId: string,
    forceChildrenTraversal?: boolean
  ): {
  ...
  static updateArrowBindings(
    page: TDPage,
    arrowShape: ArrowShape
  ): void | Partial<ArrowShape> | undefined;
  ...
  static getImageForSvg(
    svg: SVGElement,
    type?: Exclude<TDExportType, TDExportType.JSON>,
    opts?: Partial<{
      scale: number;
      quality: number;
    }>
