...
export declare const RowButton: React.ForwardRefExoticComponent<
  RowButtonProps & React.RefAttributes<HTMLButtonElement>
>;
export declare const StyledRowButton: import("@stitches/react/types/styled-component").StyledComponent<
  "button",
  {
