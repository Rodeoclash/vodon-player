...
export declare type TDToolType =
  | "select"
  | "erase"
  | TDShapeType.Text
  | TDShapeType.Draw
...
export declare type ParametersExceptFirst<F> = F extends (
  arg0: any,
  ...rest: infer R
) => any
  ? R
  : never;
export declare type ExceptFirst<T extends unknown[]> = T extends [
  any,
  ...infer U
]
  ? U
  : never;
export declare type ExceptFirstTwo<T extends unknown[]> = T extends [
  any,
  any,
  ...infer U
]
...
export declare type MappedByType<
  U extends string,
  T extends {
    type: U;
  }
...
export declare type ShapesWithProp<U> = MembersWithRequiredKey<
